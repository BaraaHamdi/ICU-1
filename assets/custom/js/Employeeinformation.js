...
$(document).ready(function () {
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot+'/hr/ar/ws/wsEmployeeInfo.asmx/GetReigion',
        data: '',
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetHireType',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetNationality',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetMaritalStatus',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetMilitaryStatus',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetGovernorate',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetEmpCode',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        type: 'POST',
        url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/GetAddressType',
        data: '',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        async: true,
    ...
    $('#firstname').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerFirstName',
    ...
    $('#middlename').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerMiddleName',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#lastname').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerLastName',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#familyname').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerFamilyName',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#attendancecode').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerAttendancecode',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#nationaliD').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerNationalID',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#socialInsurancenumber').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerSocialInsuranceNumber',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#religion').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerReligion',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#hiretype').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerHireType',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#gender').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerGender',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#nationality').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerNationality',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#maritalstatus').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerMaritalStatus',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#militarystatus').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerMilitaryStatus',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#hiredate').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerHireDate',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#birthdate').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerBirthDate',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#governorate').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerGovernorate',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('#EmpCode').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerEmployeeCode',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
    ...
    $('.addresstype').editable({
        ...
        url: function (params) {
            ...
            return $.ajax({
                type: 'POST',
                url: urlRoot + '/hr/ar/ws/wsEmployeeInfo.asmx/PerAddress',
                data: JSON.stringify(requestData),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                async: true,
