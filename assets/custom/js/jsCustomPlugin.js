(function ($) {
                ...
                buttons: [
                    {
                        ...
                        customize: function (win) {
                            ...
                            var date = new Date();
                            $(win.document.body).find('table thead').prepend('<tr><th colspan="' + colspn + '"><div style="width: 80%;float: left;padding-top: 80px;">' + settings.reporttitle + '</div><div style=" float: left;width: 20%;">' + logo + companyar + '</div></th></tr>');
    ...
    var Drow = function (IsPrint, IsPdf, IsExcel, IsCopy, Lang) {
        ...
        var div = '<div class="btn-group btn-group-solid"><div class="btn-group"><a class="btn btn-primary btn-sm" href="javascript:;" data-toggle="dropdown" aria-expanded="false"><span class="hidden-xs"> ' + Language[0] + ' </span><i class="fa fa-angle-down"></i></a><ul class="dropdown-menu">';
        if (IsPrint)
