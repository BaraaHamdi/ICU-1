    ...
    return {
        ...
        initSlimScroll: function (el) {
            ...
            $(el).each(function () {
                ...
                $(this).slimScroll({
                    ...
                    position: ($(this).attr("data-dir") ? 'right' : (isRTL ? 'left' : 'right') ),
                    height: height,
        ...
        startPageLoading: function (options) {
            if (options && options.animate) {
                ...
                $('body').css('background', '#fff').append('<div class="page-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>');
            } else {
                $('.page-loading').remove();
