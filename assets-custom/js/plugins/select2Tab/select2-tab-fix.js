...
jQuery(document).ready(function($) {
    ...
    docBody.on('select2:close', function(e) {
        ...
        if (othersOpen == 0 && clickedOutside==false) {
             ...
             */
            var inputs = currentForm.find(':input:enabled:not([readonly], input:hidden, button:hidden, textarea:hidden,button[data-tab="false"]),:button:enabled:not([readonly], input:hidden, button:hidden, textarea:hidden,button[data-tab="false"])')
