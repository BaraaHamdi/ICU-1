...
var PatientTableHospital = '';
function GetPatientTableHospital() {
    PatientTableHospital = $("#divPatientTableHospital").dxDataGrid({
        dataSource: DevExpress.data.AspNet.createStore({
            key: "PatientVisitID",
            loadUrl: urlRoot + "/api/Patient/GetHospitalPatient",
        }),
        ...
        rowTemplate: function (container, item) {
            var data = item.data,
                markup = "<tbody class='" + ((item.rowIndex % 2) ? 'dx-row-alt' : '') + "'>" +
                    ...
                    '</div>' +
                    '</div>' +
                    '<div class="m-grid-col m-grid-col-middle  m-grid-col-lg-9 m-grid-col-md-9 m-grid-col-md-8 m-grid-col-xs-8" style="padding: 12px;">' +
                    ...
                    '<div class="m-grid-row">' +
                    '<div class="m-grid-col m-grid-col-middle m-grid-col-md-12 ' + (((data.IsRegisted == true && data.IsCanceled == true) || (data.IsRegisted == false && data.IsCanceled == false)) ? "font-red" : (data.IsConfirmed == false ? "font-green" : "font-purple")) + '"><h4 style="font-weight: bold; font-size: 100%; text-align:center;">' + (((data.IsRegisted == true && data.IsCanceled == true) || (data.IsRegisted == false && data.IsCanceled == false)) ? "انتظار التسجيل" : (data.IsConfirmed == false ? "انتظار تاكيد الحجز" : "")) + '</h4></div>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    ...
                    '<button type="button" id="btnPatientVisitMedical-' + data.PatientVisitID + '" name="btnPatientVisitMedical" data-id="' + data.PatientVisitID + '" href="' + data.LastPatientVisitMedicalRecordFileUrl + '" class="btn green lightgallery"><i class="fa fa-file"></i></button>' +
                    '<button type="button" id="btnPatientVisitDetails-' + data.PatientVisitID + '" name="btnPatientVisitDetails" data-id="' + data.PatientVisitID + '" data-ismyhospital="1" style="width: 100%;" class="btn blue"><i class="fa fa-list-alt"></i></button>' +
            ...
            //    '<div class="m-grid-col m-grid-col-middle m-grid-col-md-4"><label id="patientcode" class="bold" style="font-size: 100%;">' + data.LastPatientVisitMedicalRecordFileUrl + '</label></div>' +
        ...
        rowTemplate: function (container, item) {
            var data = item.data,
                markup = "<tbody class='" + ((item.rowIndex % 2) ? 'dx-row-alt' : '') + "'>" +
                    ...
                    '<div class="m-grid-col m-grid-col-middle m-grid-col-md-3"><h4 style="color: #e7505a !important;font-weight: bold; font-size: 100%;">الوقت :' + FormatDate(data.LastPatientVisitResidenceInsertionTime) + '</h4></div>' +
                    '<div class="m-grid-col m-grid-col-middle m-grid-col-md-6"><h4 style="color: #246396 !important;font-weight: bold; font-size: 13px;">إسم المريض :' + data.FullName + '</h4></div>' +
                    '</div>' +
                    '</div>' +
                    '<div class="m-grid m-grid-responsive-xs  margin-left-10">' +
                    ...
                    //'<button type="button" id="btnPatientVisitMedical-' + data.PatientVisitID + '" name="btnPatientVisitMedical" data-id="' + data.PatientVisitID + '" data-url="' + data.LastPatientVisitMedicalRecordFileUrl + '" style="width: 100%;" class="btn green"><i class="fa fa-file"></i></button>' +
                    '<button type="button" id="btnPatientVisitMedical-' + data.PatientVisitID + '" name="btnPatientVisitMedical" data-id="' + data.PatientVisitID + '" href="' + data.LastPatientVisitMedicalRecordFileUrl + '" class="btn green lightgallery"><i class="fa fa-file"></i></button>' +
                    '<button type="button" id="btnPatientVisitDetails-' + data.PatientVisitID + '" name="btnPatientVisitDetails" data-id="' + data.PatientVisitID + '" data-ismyhospital="1" data-isicu="1" style="width: 100%;" class="btn blue"><i class="fa fa-list-alt"></i></button>' +

                    (data.IsConfirmed == true && data.IsCanceled == false ?
                        '<button type="button" id="btnPatientVisitDischarge-' + data.PatientVisitID + '" onClick="patientVisitDischarge(' + data.PatientVisitID + ')" name="btnPatientVisitDischarge" data-id="' + data.PatientVisitID + '" title="خروج المريض" style="width: 100%;" class="btn red"><i class="fa fa-sign-out"></i></button>'
                        : "") +
                    (data.IsRegisted == true && data.IsConfirmed == false && data.IsCanceled == false ?
                    (data.IsApproved != null ? '<button type="button" id="btnPatientVisitConfirm-' + data.PatientVisitID + '" name="btnPatientVisitConfirm" data-id="' + data.PatientVisitID + '" title="تأكيد الحجز" style="width: 100%;" class="btn default"><i class="fa fa-check"></i></button>'
