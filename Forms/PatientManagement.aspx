<%@ Page Title="Patient Management" Language="C#" MasterPageFile="~/Forms/Site.Master" AutoEventWireup="true" CodeBehind="PatientManagement.aspx.cs" Inherits="Re3ayaApp.Forms.PatientManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%--<a href="../assets-custom/images/girl.png" class="lightgallery"> Click to selector2 </a><br />
    <a href="../assets-custom/images/girl.png" class="lightgallery"> Click to selector3 </a><br />
    <a href="../assets-custom/images/girl.png" class="lightgallery"> Click to selector4 </a><br />--%>
    ...
    <button id="btnAddNewPatients" class="btn btn-primary" style="font-size: 20px; display: block;"><i class="fa fa-plus"></i></button>
    <a id="btnRefreshPatientList" class="btn btn-primary" style="font-size: 20px; display: block;right:40px;display:block;"><i class="fa fa-refresh"></i></a>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Footer" runat="server">
    ...
    <script src="js/jsPatientManagement.js?ver=20" type="text/javascript"></script>
    ...
    <script>
        ...
        //lightGallery(document.getElementById('selector4'), {
        //    selector: 'this',
        //});
